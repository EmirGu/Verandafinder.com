...
De gids in `assets/js/data.js` bevat **81 echte Nederlandse verandabedrijven** in alle 12 provincies, samengesteld op basis van openbare informatie van hun eigen websites (per profiel staat de bron-URL en de controle-datum). Bewuste keuzes:
